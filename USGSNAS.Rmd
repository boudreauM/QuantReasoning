...
The map includes Hydraulic Unit Codes (HUC), a system derived by USGS to delimit subregions within the country. 
	...
	In addition to the direct effects caused by the introduction and proliferation of an alien species, management strategies may themselves cause additional disruption, such as the use of molluscicides (reference).
